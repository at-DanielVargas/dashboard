...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'tracking',
        loadChildren: () => import('./screens/tracking/tracking.module').then((m) => m.TrackingModule)
      },
      {
        path: 'categories',
      ...
      {
        path: 'shop',
        loadChildren: () => import('./screens/store/store.module').then((m) => m.StoreModule)
      },
      {
        path: 'settings',
      ...
      {
        path: 'sales',
        loadChildren: () => import('./screens/sales/sales.module').then((m) => m.SalesModule)
      }
    ]
  }
]
